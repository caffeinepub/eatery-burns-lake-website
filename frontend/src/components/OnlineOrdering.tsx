...
import { ShoppingBag, Bike, Clock, Phone } from 'lucide-react';
    ...
    <div className="py-20 bg-gochujang-500">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-body text-gochujang-100 text-base sm:text-lg max-w-xl mx-auto mb-10">
          Craving authentic Korean food? Order your favourite dishes for pickup or delivery. Fresh, hot, and ready when you are!
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          <div className="flex items-center gap-2 text-gochujang-100">
            <Clock size={16} />
            <span className="font-body text-sm font-medium">Ready in 15–25 min</span>
          </div>
          <div className="flex items-center gap-2 text-gochujang-100">
            <Phone size={16} />
            <a href="tel:+61269647310" className="font-body text-sm font-medium hover:text-white transition-colors">
              +61 2 6964 7310
            </a>
          </div>
          <div className="flex items-center gap-2 text-gochujang-100">
            <ShoppingBag size={16} />
            <span className="font-body text-sm font-medium">Pickup & Delivery Available</span>
          </div>
        </div>
      </div>
    </div>
