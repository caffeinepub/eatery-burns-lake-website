...
export default function ReservationForm() {
  ...
  const { mutate: storeReservation, isPending } = useAddReservation();
  ...
  const validate = () => {
    ...
    const guests = Number.parseInt(form.guestCount);
    ...
    storeReservation(
      {
        ...
        date: form.date,
        time: form.time,
        guests: BigInt(Number.parseInt(form.guestCount)),
        notes: "",
      },
      {
        onSuccess: () => {
      ...
      <div className="py-20 bg-cream-100">
        <div className="max-w-lg mx-auto px-4 sm:px-6 text-center">
          <div className="bg-white rounded-3xl shadow-korean-xl p-10 border border-cream-200">
            <CheckCircle2
              size={64}
              className="text-gochujang-500 mx-auto mb-6"
            />
            ...
            <p className="font-body text-charcoal-400 text-base mb-6">
              Thank you for booking a table at Bunsik Korean Restaurant. We look
              forward to seeing you! We'll confirm your reservation by phone.
            </p>
            <p className="font-body text-charcoal-500 text-sm mb-8">
              Questions? Call us at{" "}
              <a
                href="tel:+61269647310"
                className="text-gochujang-500 font-bold hover:text-gochujang-400"
              >
                +61 2 6964 7310
              </a>
            </p>
            <button
              ...
              className="font-body font-bold text-sm px-8 py-3 rounded-full bg-terracotta-500 hover:bg-terracotta-400 text-white transition-colors shadow-terracotta"
            >
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="font-body text-charcoal-400 text-base">
            Reserve your table at Bunsik Korean Restaurant. We'll confirm your
            booking by phone.
          </p>
        </div>
        ...
        >
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            <div className="sm:col-span-2">
              <label
                htmlFor="old-res-name"
                className="block font-body text-charcoal-600 text-sm font-semibold mb-1.5"
              >
          ...
          <p className="font-body text-charcoal-400 text-xs text-center mt-4">
            ...
            <a
              href="tel:+61269647310"
              className="text-gochujang-500 font-semibold"
            >
              +61 2 6964 7310
            </a>{" "}
